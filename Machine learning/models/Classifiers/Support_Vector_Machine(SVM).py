...
Classifier = SVC(kernel = 'linear', random_state = 0) #first parameter is used to obtain the linear hyperplane
...
#The main daigonal represent the correct predictions and the secondary diagonal represnts the number of wrong predictions
...
#The results of this model are much more better with a gausssian kernel (kernel = 'rbf')  